...
{
    public class CSharpToAnyArchitectureAsCodeWriter
    {
        ...
        public CSharpToAnyArchitectureAsCodeWriter(string softwareSystemSourcePath, string architectureRootNamespace)
        {
        ...
        public CSharpToAnyArchitectureAsCodeWriter WithSoftwareSystemProject(string projectName)
        {
        ...
        public virtual CSharpToAnyArchitectureAsCodeWriter AddSoftwareSystem(string softwareSystemName)
        {
            return this;
        }

        public virtual CSharpToAnyArchitectureAsCodeWriter AddContainer(string softwareSystemName, string containerName)
        {
            return this;
        }

        public virtual CSharpToAnyArchitectureAsCodeWriter AddComponent(string softwareSystemName, string containerName, string componentName, ComponentType componentType = ComponentType.None)
        {
            return this;
        }

        public virtual CSharpToAnyArchitectureAsCodeWriter AddComponentInterface(
