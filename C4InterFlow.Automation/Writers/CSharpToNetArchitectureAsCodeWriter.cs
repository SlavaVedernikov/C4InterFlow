...
{
    public class CSharpToNetArchitectureAsCodeWriter : CSharpToAnyArchitectureAsCodeWriter
    {
        public CSharpToNetArchitectureAsCodeWriter(string softwareSystemSolutionPath, string architectureRootNamespace) : base(softwareSystemSolutionPath, architectureRootNamespace)
        {
        }

        public MSBuildWorkspace? ArchitectureWorkspace { get; private set; }
        public CSharpToNetArchitectureAsCodeWriter WithArchitectureProject(string architectureProjectPath)
        {
        ...
        public override CSharpToNetArchitectureAsCodeWriter AddSoftwareSystem(string softwareSystemName)
        {
        ...
        public override CSharpToNetArchitectureAsCodeWriter AddContainer(string softwareSystemName, string containerName)
        {
            var project = ArchitectureWorkspace.CurrentSolution.Projects.FirstOrDefault(x => x.Name == ArchitectureNamespace);
        ...
        public override CSharpToNetArchitectureAsCodeWriter AddComponent(string softwareSystemName, string containerName, string componentName, ComponentType componentType = ComponentType.None)
        {
            var project = ArchitectureWorkspace.CurrentSolution.Projects.FirstOrDefault(x => x.Name == ArchitectureNamespace);
        ...
        public override CSharpToNetArchitectureAsCodeWriter AddComponentInterface(
