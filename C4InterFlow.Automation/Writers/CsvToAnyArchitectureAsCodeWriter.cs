...
namespace C4InterFlow.Automation.Writers
{
    public abstract class CsvToAnyArchitectureAsCodeWriter
    {
        ...
        public class Actor
        {
            ...
            public bool TryGetType(CsvToAnyArchitectureAsCodeWriter writer, out string? type)
            {
        ...
        public class SoftwareSystem
        {
            ...
            public IEnumerable<SoftwareSystemInterface> WithInterfaces(CsvToAnyArchitectureAsCodeWriter writer)
            {
            ...
            public IEnumerable<Container> WithContainers(CsvToAnyArchitectureAsCodeWriter writer)
            {
        ...
        public class SoftwareSystemInterface
        {
            ...
            public IEnumerable<SoftwareSystemInterfaceUses> WithUses(CsvToAnyArchitectureAsCodeWriter writer)
            {
        ...
        public class Container
        {
            ...
            public IEnumerable<ContainerInterface> WithInterfaces(CsvToAnyArchitectureAsCodeWriter writer)
            {
        ...
        public class ContainerInterface
        {
            ...
            public IEnumerable<ContainerInterfaceUses> WithUses(CsvToAnyArchitectureAsCodeWriter writer)
            {
        ...
        public class BusinessProcess
        {
            ...
            public IEnumerable<BusinessActivity> WithBusinessActivities(CsvToAnyArchitectureAsCodeWriter writer)
            {
