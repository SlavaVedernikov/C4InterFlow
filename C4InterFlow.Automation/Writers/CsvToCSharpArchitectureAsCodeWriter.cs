...
{
    public class CsvToCSharpArchitectureAsCodeWriter : CsvToAnyArchitectureAsCodeWriter
    {
        public Project? ArchitectureProject { get; private set; }
        public MSBuildWorkspace? ArchitectureWorkspace { get; private set; }

        protected CsvToCSharpArchitectureAsCodeWriter(string architectureInputPath)
        {
        ...
        public static CsvToCSharpArchitectureAsCodeWriter WithCsvData(string csvRootPath)
        {
            return new CsvToCSharpArchitectureAsCodeWriter(csvRootPath);
        }
        public CsvToCSharpArchitectureAsCodeWriter WithArchitectureRootNamespace(string architectureRootNamespace)
        {
            ArchitectureNamespace = architectureRootNamespace.Trim();
            return this;
        }

        public CsvToCSharpArchitectureAsCodeWriter WithArchitectureProject(string architectureProjectPath)
        {
        ...
        public CsvToCSharpArchitectureAsCodeWriter AddActorClass(string name, string type, string? label = null)
        {
        ...
        public CsvToCSharpArchitectureAsCodeWriter AddBusinessProcessClass(string name, BusinessActivity[] businessActivities, string? label = null)
        {
            var documentName = $"{name}.cs";
            var projectDirectory = ArchitectureProject.FilePath.Replace($"{ArchitectureProject.Name}.csproj", string.Empty);
        ...
        public CsvToCSharpArchitectureAsCodeWriter AddSoftwareSystemClass(string name, string? boundary = null, string? label = null)
        {
            var documentName = $"{name}.cs";
            var projectDirectory = ArchitectureProject.FilePath.Replace($"{ArchitectureProject.Name}.csproj", string.Empty);
        ...
        public CsvToCSharpArchitectureAsCodeWriter AddSoftwareSystemInterfaceClass(SoftwareSystemInterface softwareSystemInterface)
        {
        ...
        public CsvToCSharpArchitectureAsCodeWriter AddContainerClass(string softwareSystemName, string name, string? containerType = null, string? label = null)
        {
            var documentName = $"{name}.cs";
        ...
        public CsvToCSharpArchitectureAsCodeWriter AddContainerInterfaceClass(ContainerInterface containerInterface)
        {
