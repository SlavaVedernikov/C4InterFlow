...
{
    public class CSharpToYamlArchitectureAsCodeWriter : CSharpToAnyArchitectureAsCodeWriter
    {
        public string? ArchitectureOutputPath { get; private set; }
        public CSharpToYamlArchitectureAsCodeWriter(string softwareSystemSolutionPath, string architectureRootNamespace, string architectureOutputPath) : base(softwareSystemSolutionPath, architectureRootNamespace)
        {
            ArchitectureOutputPath = architectureOutputPath;
        }

        public override CSharpToYamlArchitectureAsCodeWriter AddSoftwareSystem(string softwareSystemName)
        {
        ...
        public override CSharpToYamlArchitectureAsCodeWriter AddContainer(string softwareSystemName, string containerName)
        {
        ...
        public override CSharpToYamlArchitectureAsCodeWriter AddComponent(string softwareSystemName, string containerName, string componentName, ComponentType componentType = ComponentType.None)
        {
        ...
        public override CSharpToYamlArchitectureAsCodeWriter AddComponentInterface(
            ...
            IEnumerable<NetToAnyAlternativeInvocationMapperConfig>? alternativeInvocationMappers = null)
        {
            ...
            var flowCode = CSharpToAnyCodeGenerator<YamlCodeWriter>.GetFlowCode(
                ...
                new YamlArchitectureAsCodeReaderStrategy(architectureObject),
                this,
