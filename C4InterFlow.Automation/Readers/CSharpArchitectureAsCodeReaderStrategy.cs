...
{
    public class CSharpArchitectureAsCodeReaderStrategy : ArchitectureAsCodeReaderStrategy<NetElementsResolver>
    {
        private ClassDeclarationSyntax? CurrentClassDeclaration { get; set; }
        private MSBuildWorkspace? ArchitectureWorkspace { get; set; }

        public CSharpArchitectureAsCodeReaderStrategy()
        {

        }
        public CSharpArchitectureAsCodeReaderStrategy(ClassDeclarationSyntax currentClassDeclaration, MSBuildWorkspace architectureWorkspace) : this()
        {
