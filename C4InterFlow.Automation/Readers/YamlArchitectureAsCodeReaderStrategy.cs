...
{
    public class YamlArchitectureAsCodeReaderStrategy : ArchitectureAsCodeReaderStrategy<JObjectElementsResolver>
    {
        private JObject? RootJObject { get; set; }
        public YamlArchitectureAsCodeReaderStrategy()
        {

        }
        public YamlArchitectureAsCodeReaderStrategy(JObject rootJObject)
        {
