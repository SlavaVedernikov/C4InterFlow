...
namespace C4InterFlow.Automation
{
    public interface IAaCWriter
    {
        ...
        public IAaCWriter AddSoftwareSystem(string name, string? boundary = null, string? label = null);
        ...
        public IAaCWriter AddContainer(string softwareSystemName, string name, string? containerType = null, string? label = null);
