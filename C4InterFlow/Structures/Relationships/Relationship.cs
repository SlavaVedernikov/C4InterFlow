namespace C4InterFlow.Structures.Relationships;
...
public record Relationship
{
    ...
    /// <param name="to"></param>
    /// <param name="label"></param>
    public Relationship(string @from, Direction direction, string to, string label)
        : this(from, direction, to, label, string.Empty, Position.None)
    {
    }
    ...
    public static Relationship operator |(Relationship a, (string label, string protocol) b)
    {
