...
%cli-output-dir%\%cli-exe% execute-aac-strategy --aac-root-namespace "%aac-root-namespace%" --aac-output-path "%aac-root-namespace%\%aac-root-namespace%.csproj" --aac-writer-strategy "C4InterFlow.Automation.NetToNetBasketApiAaCGenerationStrategy, C4InterFlow.Automation" --aac-params software-system-source-path="%net-sourcecode-dir%\Basket.API\Basket.API.csproj" --aac-params software-system-name="BasketApi"

%cli-output-dir%\%cli-exe% execute-aac-strategy --aac-root-namespace "%aac-root-namespace%" --aac-output-path "%aac-root-namespace%\%aac-root-namespace%.csproj" --aac-writer-strategy "C4InterFlow.Automation.NetToNetCatalogApiAaCGenerationStrategy, C4InterFlow.Automation" --aac-params software-system-source-path="%net-sourcecode-dir%\Catalog.API\Catalog.API.csproj" --aac-params software-system-name="CatalogApi"
pause
