                ...
                public partial class Components
                {
                    public partial class CatalogContext
                    {
                        public partial class Interfaces
                        {
                            ...
                            {
                                public static Interface Instance => new Interface(Utils.GetStructureAlias<CatalogBrandsSingleOrDefault>(), "Catalog Brands Single Or Default")
                                {
                                    Description = "",
                                    Path = "",
                                    IsPrivate = false,
                                    Protocol = "",
                                    Flow = new Flow(Utils.GetStructureAlias<CatalogBrandsSingleOrDefault>()),
                                    Input = "",
                                    InputTemplate = "",
                                    Output = "",
                                    OutputTemplate = ""
