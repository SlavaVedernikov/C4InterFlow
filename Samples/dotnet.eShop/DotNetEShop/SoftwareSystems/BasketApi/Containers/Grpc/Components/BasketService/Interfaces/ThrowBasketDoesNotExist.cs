                ...
                public partial class Components
                {
                    public partial class BasketService
                    {
                        public partial class Interfaces
                        {
                            ...
                            {
                                public static Interface Instance => new Interface(Utils.GetStructureAlias<ThrowBasketDoesNotExist>(), "Throw Basket Does Not Exist")
                                {
                                    Description = "",
                                    Path = "",
                                    IsPrivate = true,
                                    Protocol = "",
                                    Flow = new Flow(Utils.GetStructureAlias<ThrowBasketDoesNotExist>()),
                                    Input = "",
                                    InputTemplate = "",
                                    Output = "",
                                    OutputTemplate = ""
