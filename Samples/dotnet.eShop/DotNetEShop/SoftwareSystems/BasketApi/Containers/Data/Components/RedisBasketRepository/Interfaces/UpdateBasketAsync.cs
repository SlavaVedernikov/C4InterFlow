                ...
                public partial class Components
                {
                    public partial class RedisBasketRepository
                    {
                        public partial class Interfaces
                        {
                            ...
                            {
                                private static readonly string ALIAS = "DotNetEShop.SoftwareSystems.BasketApi.Containers.Data.Components.RedisBasketRepository.Interfaces.UpdateBasketAsync";
                                public static Interface Instance => new Interface(DotNetEShop.SoftwareSystems.BasketApi.Containers.Data.Components.RedisBasketRepository.ALIAS, ALIAS, "Update Basket Async")
                                {
                                    Description = "",
                                    Path = "",
                                    IsPrivate = false,
