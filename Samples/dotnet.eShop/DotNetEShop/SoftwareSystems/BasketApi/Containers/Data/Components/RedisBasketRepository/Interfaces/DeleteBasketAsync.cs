                ...
                public partial class Components
                {
                    public partial class RedisBasketRepository
                    {
                        public partial class Interfaces
                        {
                            ...
                            {
                                private static readonly string ALIAS = "DotNetEShop.SoftwareSystems.BasketApi.Containers.Data.Components.RedisBasketRepository.Interfaces.DeleteBasketAsync";
                                public static Interface Instance => new Interface(DotNetEShop.SoftwareSystems.BasketApi.Containers.Data.Components.RedisBasketRepository.ALIAS, ALIAS, "Delete Basket Async")
                                {
                                    Description = "",
                                    Path = "",
                                    IsPrivate = false,
