...
{
    public class CSharpToYamlCatalogApiAaCGenerationStrategy : CSharpToYamlArchitectureAsCodeStrategy
    {
        public override void Execute()
        {
            ...
            var writer = new CSharpToYamlArchitectureAsCodeWriter(SoftwareSystemSourcePath, ArchitectureRootNamespace, ArchitectureOutputPath);
        ...
        private void AddSoftwareSystemTypeMapping(CSharpToYamlArchitectureAsCodeWriter writer)
        {
