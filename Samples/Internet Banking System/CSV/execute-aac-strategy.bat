...
CALL :NormalizePath "%aac-output-path%"
SET "aac-output-path=%_NORMALIZED_PATH_%"
CALL :NormalizePath "%aac-input-path%"
SET "aac-input-path=%_NORMALIZED_PATH_%"
...
if "%ENABLE_LINE_DRAWING%"=="" (
    ...
    echo x %DISABLE_LINE_DRAWING%aac-input-path      %ENABLE_LINE_DRAWING%x %DISABLE_LINE_DRAWING%%COLOR_FG_CYAN%%aac-input-path%%COLOR_RESET%%ENABLE_LINE_DRAWING%
    echo x %DISABLE_LINE_DRAWING%aac-output-path     %ENABLE_LINE_DRAWING%x %DISABLE_LINE_DRAWING%%COLOR_FG_CYAN%%aac-output-path%%COLOR_RESET%%ENABLE_LINE_DRAWING%
    ...
    echo x %DISABLE_LINE_DRAWING%cli-project-path    %ENABLE_LINE_DRAWING%x %DISABLE_LINE_DRAWING%%COLOR_FG_CYAN%%cli-project-path%%COLOR_RESET%%ENABLE_LINE_DRAWING%
    echo x %DISABLE_LINE_DRAWING%cli-output-dir      %ENABLE_LINE_DRAWING%x %DISABLE_LINE_DRAWING%%COLOR_FG_CYAN%%cli-output-dir%%COLOR_RESET%%ENABLE_LINE_DRAWING%
